...
**string.Template** is a simple, built-in templating system in Python used to replace placeholders inside a string.

- It is part of Python’s standard library, in the string module.
...
- It is NOT as powerful as Jinja2, but it is very easy to use.

### Example of string.Template:
```python
from string import Template

temp = Template("Hello ${name}, welcome to ${place}!")
output = temp.substitute(name="Prince", place="Bihar")
